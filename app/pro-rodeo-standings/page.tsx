...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Track pro rodeo standings, PRCA standings, WPRA standings, world standings, circuit standings, athlete rankings, season earnings, and rodeo results in Rodeo Daily.",
